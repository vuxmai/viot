...
from app.module.team.model import UserTeam
...
from .dto import PagingTeamInvitationDto, TeamInvitationCreateDto, TeamInvitationDto
from .exception import TeamInvitationNotFoundException
from .model import TeamInvitation
...
class TeamInvitationService:
    ...
    async def create_team_invitation(
        ...
        self._email_service.send_team_invitation_email(
            ...
            team_name=team.name,
            link=f"{settings.UI_URL}/{team.slug}/invitations?token={invitation.token}",
        )
