...
class DeviceService:
    ...
    async def get_device_by_id(self, *, device_id: UUID) -> DeviceDto:
        device = await self._device_repository.find(device_id)
        if device is None:
    ...
    async def delete_device_by_id(self, *, device_id: UUID) -> None:
        await self._device_repository.delete_by_id(device_id)
